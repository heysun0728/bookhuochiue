<?php
function usergroupform_del($rst,$updateNumer){

        ?>
    <form method="post" id="usergroup_form" class="yellowform">
        <div id="form_type2" style="position:absolute;top:3%;">
            <label for="group-input">群組名稱</label>
            <input id="group-input" name="group-input" type="text" value="<?php echo $rst['RoleName'];?> "/>
            <label for="groupid-input">群組ID  </label>
            <input id="groupid-input" name="groupid-input" type="text" value="<?php echo $rst['RoleID'];?> " />
        </div>
        <br/>
        ...
        <table border="1" rules="none" style="min-width: 600px; border-style: none">
            ...
            <tr>
                ...
                <td>
                    <br/>
                    <input type="submit" style="margin:auto auto;" value="刪除"/>
                </td>
                <td></td>
            </tr>
