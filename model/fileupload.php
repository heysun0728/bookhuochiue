 ...
 */
function uploadFile($fileInfo, $allowExt = array('jpeg', 'jpg', 'gif', 'png','doc','docx','pdf'), $maxSize =104857600, $flag = true, $uploadPath = '../upload') {
    // 存放錯誤訊息
    $res = array();
    ...
    if (!empty($res))
        ...
        // 將檔案從臨時目錄移至指定目錄
        if (!@move_uploaded_file($fileInfo['tmp_name'],iconv("UTF-8","big5",$destination))){
          // 如果移動檔案失敗
