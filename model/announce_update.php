...
<?php
	...
	$rst=$rs->fetch();
			//載入修改學校的表單
			echo "<div class=\"main\">";
           	echo "<form id=\"form_type1\" style=\"left:5%\" enctype=\"multipart/form-data\" method=\"post\">";
    
	        echo "<input name=\"no\" id=\"input-index\" type=\"hidden\"  value=". $rst["A_No"] ."><br/>"; 
            
	        echo "<div class=\"form-type\"><label for=\"input-title\">公告標題：</label>";
	        echo "<input name=\"title\" id=\"input-title\" type=\"text\"  value=". $rst["ATitle"] ."><br/>";

	         echo "<div class=\"form-type\"><label for=\"input-subtitle\">副標題：</label>";
	        echo "<input name=\"subtitle\" id=\"input-subtitle\" type=\"text\"  value=". $rst["ASubtitle"] ."><br/></div>";

	        echo "<div class=\"form-type\"><label for=\"input-type\">公告類型：</label>";
	        echo "<input name=\"type\" id=\"input-type\" type=\"text\" value=".$rst["AType"]."><br/></div>";
            
	        echo "<div class=\"form-group\"><label for=\"input-context\">公告內容：</label>";
	        ...
	        echo "<div class=\"form-group\"><label>公告圖片：</label>";
	        echo "<img src=../upload/".$rst["AImage"]." width=\"200\" height=\"150\"\>";
	        echo "<div class=\"form-group\"><label for=\"input-img\">重新上傳：</label>";
